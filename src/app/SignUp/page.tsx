        ...
        <div className="min-h-screen text-gray-900 flex justify-center">
            <div className="max-w-screen-xl m-0 sm:m-10 bg-slate-700 shadow sm:rounded-lg flex justify-center flex-1">
                <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                    <div>
                        <Image src="/logo.png"
                            className="mx-auto" alt="Image" width={350} height={350} />
                    </div>
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            ...
                            <div className="my-12 border-b text-center">
                                <div
                                    className="leading-none px-2 inline-block text-sm text-gray-100 tracking-wide font-medium bg-slate-700 transform translate-y-1/2">
                ...
                <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style={{ backgroundImage: 'url("/SignUp.avif")' }}>
                    </div>
                </div>
