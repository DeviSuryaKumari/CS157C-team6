        ...
        <div className="w-full max-w-sm hover:outline border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5 text-center">
                ...
                <div className="justify-evenly items-center mt-2.5 mb-5 text-start">
                    <p className='text-sm text-gray-100 font-semibold'>Genres: Action </p>
                    <p className='text-sm text-gray-100 font-semibold'>Director: Name </p>
                    <p className='text-sm text-gray-100 font-semibold'>Features: Name, Name </p>
                </div>
